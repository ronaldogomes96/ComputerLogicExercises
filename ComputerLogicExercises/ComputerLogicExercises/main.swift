...
print("\(formula3.getFormulaDescription()): \(functions.tableaux(formulas: [formula3], isUsed: [1]))")
print("\(formula13.getFormulaDescription()): \(functions.tableaux(formulas: [formula13], isUsed: [1]))")
print("\(formula10.getFormulaDescription()): \(functions.tableaux(formulas: [formula10], isUsed: [1]))")
print("\(formula8.getFormulaDescription()): \(functions.tableaux(formulas: [formula8], isUsed: [1]))")
print("\(formula15.getFormulaDescription()): \(functions.tableaux(formulas: [formula15], isUsed: [1]))")
print("\(formula14.getFormulaDescription()): \(functions.tableaux(formulas: [formula14], isUsed: [1]))")
print("\(formula17.getFormulaDescription()): \(functions.tableaux(formulas: [formula17], isUsed: [1]))")
print("\(formula18.getFormulaDescription()): \(functions.tableaux(formulas: [formula18], isUsed: [1]))")
print("\(formula19.getFormulaDescription()): \(functions.tableaux(formulas: [formula19], isUsed: [1])))")
