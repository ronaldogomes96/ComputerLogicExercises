...
print("Contradição")
print("\(formula0.getFormulaDescription()) + \(formula2.getFormulaDescription()) contra \(functions.isContradiction(results: [formula0, formula2]))")
print("\(formula2.getFormulaDescription()) + \(formula0.getFormulaDescription()) contra \(functions.isContradiction(results: [formula0, formula2]))")
print("\(formula0.getFormulaDescription()) + \(formula1.getFormulaDescription()) contra \(functions.isContradiction(results: [formula0, formula1]))")

print("Tableaux de cada formula")
print("\(formula3.getFormulaDescription()): \(functions.tableaux(formulas: [formula3], isCheck: [false]))")
print("\(formula13.getFormulaDescription()): \(functions.tableaux(formulas: [formula13], isCheck: [false]))")
print("\(formula10.getFormulaDescription()): \(functions.tableaux(formulas: [formula10], isCheck: [false]))")
print("\(formula8.getFormulaDescription()): \(functions.tableaux(formulas: [formula8], isCheck: [false]))")
print("\(formula15.getFormulaDescription()): \(functions.tableaux(formulas: [formula15], isCheck: [false]))")
print("\(formula14.getFormulaDescription()): \(functions.tableaux(formulas: [formula14], isCheck: [false]))")
print("\(formula17.getFormulaDescription()): \(functions.tableaux(formulas: [formula17], isCheck: [false]))")
print("\(formula18.getFormulaDescription()): \(functions.tableaux(formulas: [formula18], isCheck: [false]))")
print("\(formula19.getFormulaDescription()): \(functions.tableaux(formulas: [formula19], isCheck: [false])))")
